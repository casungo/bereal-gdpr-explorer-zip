...
<aside
  class="min-h-full w-64 bg-base-200 text-base-content flex flex-col"
>
  <div
  ...
  >
    ...
    >
      ...
      >
        ...
        >
          <span
            class="text-primary-content font-bold text-sm"
            >BR</span
          >
        </div>
        <div
    ...
    >
      ...
      <ul
        class="menu menu-vertical w-full space-y-1"
      >
        {#each mainTabs as tab}
          <li
          >
            <button
              class="w-full justify-start gap-3 {activeTab ===
              tab.id
                ? 'active'
                : ''}"
              onclick={() =>
    ...
    <div
      class="p-4 border-t border-base-300 space-y-2"
    >
      <a
