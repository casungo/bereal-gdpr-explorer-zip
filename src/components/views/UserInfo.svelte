...
>
  <div
    class="card bg-gradient-to-br from-primary/10 to-secondary/10 shadow-xl"
  >
    <div
      class="card-body"
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            {:else}
              <div
                class="bg-primary/20 flex items-center justify-center"
              >
                <UserIcon
        ...
        <div
          class="text-center md:text-left flex-1"
        >
          <h1
  ...
  >
    ...
    >
      ...
      >
        ...
        <div
          class="stat-value text-secondary text-lg"
        >
          {user.location ||
            "N/A"}
        </div>
    ...
    >
      ...
      >
        ...
        <div
          class="stat-value text-accent text-lg"
        >
          {platformName}
        </div>
        <div
    ...
    >
      ...
      >
        ...
        <div
          class="stat-value text-info text-lg"
        >
          {user.timezone?.split(
            "/",
          )[1] ||
