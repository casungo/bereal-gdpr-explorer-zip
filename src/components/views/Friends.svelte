            ...
            >
              ...
              >
                {#each friendsSortable.sortedItems as friend}
                  {@const friendshipDateObj =
                    new Date(
                      friend.friendshipDate,
                    )}
                  {@const formattedFriendshipDate =
                    isValid(
                      friendshipDateObj,
                    )
                      ? format(
