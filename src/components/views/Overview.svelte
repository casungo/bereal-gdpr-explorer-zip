...
import type { BeRealData, MediaMap, Post, Memory, Realmoji } from "@/lib/types";
...
>
  ...
  >
    <div
      class="card bg-base-100 shadow-xl lg:col-span-2"
    >
      <div
        class="card-body"
      >
        ...
        >
          <div
            class="flex items-end justify-center h-64 space-x-2 px-4"
          >
    ...
    >
      ...
      >
          ...
          >
            <div
              ...
              style="background: conic-gradient(
								hsl(var(--su)) 0deg {onTimePercentage *
                3.6}deg,
								hsl(var(--er)) {onTimePercentage *
                3.6}deg 360deg
							)"
            ></div>
            <div
        ...
        >
          ...
          >
            <div
              class="w-4 h-4 bg-success rounded"
            ></div>
            <span
              class="text-sm"
              >On
          ...
          >
            <div
              class="w-4 h-4 bg-error rounded"
            ></div>
            <span
              class="text-sm"
              >Late
                ...
                >
                  ...
                  >
                    <div
                      ...
                      class:bg-primary={index ===
                        0}
                      class:bg-secondary={index ===
                        1}
                      class:bg-accent={index ===
                        2}
                      class:bg-info={index ===
                        3}
                      class:bg-warning={index >=
                        4}
                      style="width: {percentage}%"
                    ></div>
                  </div>
