...
>
  <div
    class="grid gap-6 lg:grid-cols-1"
  >
    <div
              ...
              >
                {#each tokensSortable.sortedItems as token}
                  ...
                  >
                    ...
                    >
                    <td
                      class="truncate max-w-xs text-base-content/50 text-xs"
                    >
                      <span
                        class="tooltip"
                        data-tip={token.token}
                      >
